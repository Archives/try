...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        void ApplySkillDependentEnchantments(uint16 skill, bool apply);
        ...
        bool CastItemCombatSpellFromOtherWeapon(Unit* Target, WeaponAttackType attType);
