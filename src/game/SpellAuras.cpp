...
pAuraHandler AuraHandler[TOTAL_AURAS]=
{
    ...
    &Aura::HandleAuraModDispelResist,                       //235 SPELL_AURA_MOD_DISPEL_RESIST               implement in Unit::MagicSpellHitResult CHANGED TO: implemented in Spell::EffectDispel and Spell::EffectStealBeneficialBuff
        ...
        if (spellProto->Id == 47788)
        {
            ...
            if (target->IsInWorld() && GetStackAmount()>0)
            {
                if (caster)
                    ...
                    {
                        ((Player*)caster)->RemoveSpellCooldown(47788,true);
...
void Aura::PeriodicTick()
{
    ...
    switch(m_modifier.m_auraname)
    {
        ...
        case SPELL_AURA_PERIODIC_DAMAGE_PERCENT:
        {
            ...
            target->CalculateAbsorbAndResist(pCaster, GetSpellSchoolMask(spellProto), DOT, pdamage, &absorb, &resist, true);
