...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "lfg_dungeon_info",            SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadLfgDungeonInfoCommand,          "", NULL },
        ...
        { "quest_lfg_relation",          SEC_ADMINISTRATOR, true,  &ChatHandler::HandleReloadQuestLfgRelationCommand,        "", NULL },
